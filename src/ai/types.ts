...
export interface AIProvider {
  ...
  /**
   * One step of a coach turn on the coach service (docs/PRD_COACH_CHAT.md §13): the coach Worker in production, the
   * Vite dev bridge locally. Absent on direct-key and mock providers, where coach chat answers from local data.
   */
  coachTurn?(req: CoachTurnRequest): Promise<CoachTurnResponse>
}
