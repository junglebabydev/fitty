...
- **Secrets are not in a Keychain yet.** The Anthropic key is stored in the local `settings` table (and therefore inside a JSON export). Under Capacitor it should move to iOS Keychain.
